...
class MovieBookingScreen extends StatefulWidget {
  ...
  const MovieBookingScreen({Key? key, this.movieTitle}) : super(key: key);
...
class _MovieBookingScreenState extends State<MovieBookingScreen> {
  ...
  final selectedTime =
      ValueNotifier<TimeOfDay?>(null); // Add selectedTime property
  ...
  Widget build(BuildContext context) {
    ...
    final movieTitle = arguments?['movieTitle'] as String? ?? 'Movie Title';
    final movieImage = arguments?['movieImage'] as String? ?? 'Movie Image';
                              ...
                              child: InkWell(
                                onTap: () {
                                  if (selectedTime.value != null) {
                                    ...
                                    // แสดงการแจ้งเตือนหรือข้อความว่าผู้ใช้ยังไม่ได้เลือกเวลา
